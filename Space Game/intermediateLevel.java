...
public class intermediateLevel extends JPanel implements KeyListener, ActionListener{
	Timer timer = new Timer(25, this);
	
	private String userName;
	private int score = 0;
	private spaceShip ship = new spaceShip();
	private BufferedImage shipImage, alienImage, bulletImage, blueAlienImage;
	
	private ArrayList<bullet> bullets = new ArrayList<bullet>();
	private ArrayList<alien> aliens = new ArrayList<alien>();
	
	
	public intermediateLevel(String userName) {
